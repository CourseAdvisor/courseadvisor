...
.on post: "/api/comment", followAllRedirects: true, body: { review_id: 2, body: "Valar morghulis" }
...
test "Edit a comment"
.on post: "/api/comment/edit", followAllRedirects: true, body: { comment_id: 6, body: "Valar dohaeris" }
.withCSRF().withUser "snow"
.is (rq) ->
  rq.addHeader "referer", url("/en/course/chemistry-of-food-processes-899")
    .expectStatus 200
...
.on post: "/api/comment", followAllRedirects: true, body: { parent_id: 6, review_id: 2, body: "You know nothing" }
.withCSRF().withUser "snow"
.is (rq) ->
  rq.addHeader "referer", url("/en/course/chemistry-of-food-processes-899")
    .expectStatus 200
...
.on post: "/api/comment", followAllRedirects: true, body: { review_id: 2 }
.withCSRF().withUser "snow"
.is (rq) ->
...
.on post: "/api/comment", followAllRedirects: true, body: { body: "Valar dohaeris" }
.withCSRF().withUser "snow"
.is (rq) ->
  rq.addHeader "referer", url("/api/errors")
