...
<p>{{{ ucfirst($who->fullname) }}} a commenté ton avis pour le cours {{{ $review->course->name_fr }}}.<br />
...
<p>{{{ ucfirst($who->fullname) }}} has commented on your review in the course {{{ $review->course->name_en }}}.<br />
