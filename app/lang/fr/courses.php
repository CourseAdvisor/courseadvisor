...
return array(
  ...
  'create-review-message' => 'Merci de prendre deux minutes pour donner votre avis sur ce cours.',
  'review-title-placeholder' => 'Impression générale',

  'review-body-placeholder' => 'Est-ce que ce cours était utile ? Etait-il intéressant ? Exprime ta propre opinion.',
  'incomplete-grading-message' => 'Merci de noter tous les aspects du cours.',
  'anonymous-post-label' => 'Avis anonyme',
  'anonymous-post-helper' => 'Si tu postes en anonyme, ton nom n\'apparaîtra pas mais ton avis devra d\'abord être validé par un modérateur.',
  'grade-lectures-helper' => 'Comment as-tu trouvé les leçons? Le prof était il intéressant? Etait-il facile à comprendre?',
  'grade-exercises-helper' => 'Les exercices étaient-il en rapport avec le cours? T\'ont-ils aidés à mieux comprendre le sujet?',
